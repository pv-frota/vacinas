...
class ManipulateAnimalScreen extends HookWidget {
  ManipulateAnimalScreen({Key? key}) : super(key: key);
                  ...
                  child: Column(
                    children: [
                      TextFormField(
                        ...
                        onChanged: (value) => state.nome = value,
                        validator: (value) {
                      ...
                      TextFormField(
                        ...
                        onChanged: (value) => state.dono = value,
                        validator: (value) {
                          if (value == null || value.isEmpty) {
                      ...
                      TextFormField(
                        ...
                        onChanged: (value) => state.telefone = value,
                        validator: (value) {
                          if (value == null || value.isEmpty) {
                      ...
                      DropdownButtonFormField<String?>(
                        ...
                        onChanged: (value) => state.tipo = value,
                        validator: (value) {
                          if (value == null || value.isEmpty) {
